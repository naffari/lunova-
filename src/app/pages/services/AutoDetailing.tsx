        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-[1fr_480px] gap-12 items-center">
          <div>
            ...
            >
              ...
              <span>KC's Mobile Auto Detailing Service</span>
            </div>
            ...
            <h1
              ...
              style={{ color: PRIMARY }}
            >
              Your Car, <span className="italic" style={{ color: ACCENT }}>Detailed</span> <br />
              At Your Doorstep.
            </h1>

            <p className="text-base sm:text-lg max-w-xl mb-8 leading-relaxed" style={{ color: `${PRIMARY}bb` }}>
              We bring professional-grade detailing directly to your home or office. From express washes to full paint protection — your vehicle deserves the best.
            </p>
            ...
            <div className="mt-10 pt-8 flex items-center gap-6 text-xs" style={{ borderTop: `1px solid ${PRIMARY}20` }}>
              <span className="font-semibold" style={{ color: PRIMARY }}>Mobile Service</span>
              <span style={{ color: `${PRIMARY}40` }}>•</span>
              <span className="font-semibold" style={{ color: PRIMARY }}>Ceramic Coating Available</span>
              <span style={{ color: `${PRIMARY}40` }}>•</span>
              <span className="font-semibold" style={{ color: PRIMARY }}>Interior Steam Clean</span>
            </div>
          </div>
          ...
          <div className="relative flex justify-center">
            ...
            <div className="relative z-10 w-full max-w-md h-[460px] sm:h-[520px] rounded-[36px] overflow-hidden border-4 border-white shadow-2xl" style={{ backgroundColor: PRIMARY }}>
              <img
                src="https://images.unsplash.com/photo-1520340356584-f9917d1eea6f?w=800&h=1000&fit=crop&auto=format"
                alt="Mobile Auto Detailing Professional"
              ...
              >
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wider" style={{ color: ACCENT }}>Auto Detailing by Lunova</p>
                  <p className="font-serif-display text-xl text-white">Mobile Detailing Specialists</p>
                </div>
